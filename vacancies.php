...
<head>
    ...
    <title>Robot Machines - Вакансии</title>
...
<body>
    ...
    <section class="vacancy">
        <h2 id="vacancyTitle" class="title">
            Вакансии
        </h2>
    ...
    <section id="enrollVacancy" class="enroll">
        <div class="container">
            <h2 id="vacancyEnrollTitle" class="title">Откликнуться</h2>

            <div class="enroll-wrapper">
                <div class="enroll__info gs_reveal ">
                    <h3 id="vacanciesEnrollTitle" class="enroll__info-title">Найдите работу у нас</h3>
                ...
                <form class="enroll__form gs_reveal " action="./mail/mail.php" method="post">
                    ...
                    <div class="enroll__form-item">
                        <button id="vacancyEnrollBtn" class="enroll__form-btn" type="submit">Откликнуться</button>
                    </div>
                </form>
            </div>
        </div>

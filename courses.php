...
<body>
    ...
    <section class="course">
        <h2 id="chooseCourseTitle" class="title">Выберите подходящий курс</h2>
        <div class="container">
                    ...
                    <a href="index3.php" class="course__list-link">
                        <div class="course__item-article">
                            ...
                            <p id="roboticsArticle" class="course__item-text">Приготовьтесь открыть для своего ребенка
                                мир робототехники,
                                схемотехники и цифровой грамотности. В конце курса, ребята займутся подкреплением
                                полученных
                                знаний с помощью сборки собственного робота и его подготовки к грандиозному робо-бою!
                            </p>
                        </div>

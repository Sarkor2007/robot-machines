...
<head>
    ...
    <title>Robot Machines - Партнёры</title>
...
<body>
    ...
    <section class="partners">
        <h2 id="partnersTitle" class="title">Наши партнёры</h2>

        <div class="container">
            <div class="partners-swiper swiper mySwiperThree">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="images/images/partners/partner.webp" alt="partner">
                    </div>
                    <div class="swiper-slide">
                        <img src="images/images/partners/partner2.webp" alt="partner">
                    </div>
                    <div class="swiper-slide">
                        <img src="images/images/partners/partner3.webp" alt="partner">
                    </div>
                    <div class="swiper-slide">
                        <img src="images/images/partners/partner4.webp" alt="partner">
                    </div>
                    <div class="swiper-slide">
                        <img src="images/images/partners/partner5.webp" alt="partner">
                    </div>
                    <div class="swiper-slide" style="background-color: black;">
                        <img src="images/images/partners/partner6.webp" alt="partner">
                    </div>
                    <div class="swiper-slide" style="background-color: #312f30;">
                        <img src="images/images/partners/partner7.webp" alt="partner">
                    </div>
                    <div class="swiper-slide" style="background-color: black;">
                        <img src="images/images/partners/partner8.webp" alt="partner">
                    </div>
                    <div class="swiper-slide" style="background-color:#a04a84;">
                        <img src="images/images/partners/partner9.webp" alt="partner">
                    </div>
                    <div class="swiper-slide">
                        <img src="images/images/partners/partner10.webp" alt="partner">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bepartner">
        <h2 id="becomePartnerTitle" class="title">Как стать партнёром</h2>

        <div class="container">
            <ul class="bepartner__list">
                <li class="bepartner__list-item gs_reveal gs_reveal_fromLeft">
                    <div class="bepartner__item-content">
                        <h3 id="bepartnerTitleOne" class="bepartner__item-title">
                            Условие сотрудничества для частных школ
                        </h3>
                        <p id="bepartnerArticleOne" class="bepartner__item-text">
                            Мы открыты к сотрудничеству с частными школами и готовы предложить Вам полную методичку и
                            преподавательский состав для проведения уроков по робототехнике и IT, а также предоставлять
                            все необходимые материалы для уроков.
                        </p>
                    </div>
                    <div class="bepartner__item-num one">
                        1
                    </div>
                </li>
                <li class="bepartner__list-item gs_reveal gs_reveal_fromRight">
                    <div class="bepartner__item-content">
                        <h3 id="bepartnerTitleTwo" class="bepartner__item-title">
                            Условие сотрудничества для выездных мастер-классов
                        </h3>
                        <p id="bepartnerArticleTwo" class="bepartner__item-text">
                            Наш клуб предоставляет услуги по проведению выездных мастер классов по робототехнике и IT по
                            всему Узбекистану. Также есть возможность выезда в соседние страны. Это могут быть
                            эксперименты, сборка или проведение мастер класса на выбранную Вами тему. Всё необходимое
                            для проведения мастер классов мы предоставляем сами!
                        </p>
                    </div>
                    <div class="bepartner__item-num two">
                        2
                    </div>
                </li>
                <li class="bepartner__list-item gs_reveal gs_reveal_fromLeft">
                    <div class="bepartner__item-content">
                        <h3 id="bepartnerTitleThree" class="bepartner__item-title">
                            Условие сотрудничества для учебных центров
                        </h3>
                        <p id="bepartnerArticleThree" class="bepartner__item-text">
                            Если у вас есть учебный центр, мы рады работать вместе! Наша команда непрерывно расширяется
                            и поэтому мы открыты к сотрудничеству с учебными центрами, которые готовы предложить нам
                            свои кабинеты на выходные дни, либо преподавать робототехнику или IT, Вашим ученикам.
                        </p>
                    </div>
                    <div class="bepartner__item-num three">
                        3
                    </div>
                </li>
            </ul>
    ...
    <section class="enroll">
        <div class="container">
            <h2 id="bepartnerTitle" class="title">Стать партнёром</h2>

            <div class="enroll-wrapper">
                <div class="enroll__info gs_reveal">
                    <h3 id="bepartberEnrollTitle" class="enroll__info-title">Оставьте свои данные наши менеджеры
                        свяжутся с вами</h3>
                    <div class="enroll__info-img">
                        <img src="images/images/whyus3.webp" alt="enroll image">
                    </div>
                </div>
                <form class="enroll__form gs_reveal" action="./mail/mail_part.php" method="post">
                    <div class="enroll__form-item">
                        <label id="enrollLabelThree" class="enroll__form-label" for="companyInput">Название вашей
                            компании</label>
                        <input class="enroll__form-input" placeholder="Введите название" type="text" name="company"
                            id="companyInput">
                    </div>
                    <div class="enroll__form-item">
                    ...
                    <div class="enroll__form-item">
                        <label for="accept" class="enroll__form-text">
                            ...
                            <p id="bepartnerEnrollTerms"> Нажимая кнопку “Получить консультацию”, Вы
                                соглашаетесь с
                                <span> условиями
                    ...
                    <div class="enroll__form-item">
                        <button id="bepartnerBtn" class="enroll__form-btn" type="submit">Стать партнёром</button>
                    </div>
                </form>
            </div>
        </div>

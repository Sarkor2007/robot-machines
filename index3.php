...
<head>
    ...
    <title>Robot Machines - Курс Робототехника</title>
            ...
            <div class="about-wrapper">
                <div class="about-box">
                    <div class="about-content">
                        <h3 id="roboticsTitle" class="about-title">Робототехника</h3>
                    ...
                    <div class="about-img">
                        <img src="images/images/main2.webp" alt="main image">
                    </div>
                </div>
    ...
    <section class="enroll">
        <div class="container">
            ...
            <div class="enroll-wrapper">
                <div class="enroll__info">
                    <h3 id="enrollCourseTitle" class="enroll__info-title">Для записи оставьте свои контакты</h3>
                    <div class="enroll__info-img">
                        <img src="images/images/whyus3.webp" alt="enroll image">
                    </div>
                </div>
                <form class="enroll__form" action="./mail/mail.php" method="post">
                    ...
                    <div class="enroll__form-item">
                        <button id="enrollCourseBtn" class="enroll__form-btn" type="submit">Записаться</button>
                    </div>
                </form>
            </div>
        </div>

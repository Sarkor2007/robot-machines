...
<head>
    ...
    <title>Robot Machines - Курсы</title>
...
<body>
    ...
    <section class="enroll enroll-second">
        <h2 id="contactsTitle" class="title">
            Контакты
        </h2>
        <div class="container">
            ...
            <div class="enroll-wrapper">
                <div class="enroll__info gs_reveal">
                    <h3 id="leaveContacts" class="enroll__info-title">Оставьте свои контакты.</h3>
                ...
                <form class="enroll__form gs_reveal" action="./mail/mail.php" method="post">
                    ...
                    <div class="enroll__form-item">
                        <button class="enroll__form-btn" type="submit">Получить обратную связь</button>
                    </div>
                </form>
                <ul class="enroll__social gs_reveal">
                    <li class="enroll__social-item">
                        <a class="enroll__social-link" href="#">
